...
local function addBlur(parent)
	...
	blur.Image = getcustomasset('vape67/assets/new/blur.png')
...
local hash = loadstring(downloadFile('vape67/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('vape67/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('vape67/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
	...
	function whitelist:update(first)
		local suc = pcall(function()
			local _, subbed = pcall(function()
				return game:HttpGet('https://github.com/0x6767/whitelists')
			end)
			local commit = subbed:find('currentOid')
			commit = commit and subbed:sub(commit + 13, commit + 52) or nil
			commit = commit and #commit == 40 and commit or 'main'
			whitelist.textdata = game:HttpGet('https://raw.githubusercontent.com/0x6767/whitelists/'..commit..'/PlayerWhitelist.json', true)
		end)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('vape67/profiles/whitelist.json') and readfile('vape67/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('vape67/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('vape67/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('vape67/assets/new/radaricon.png'),
